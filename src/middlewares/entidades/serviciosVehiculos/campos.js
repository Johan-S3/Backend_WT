/**
 * Definición de los campos para la validación de servicios de vehiculos.
 * 
 ...
 */
export const campos = [
  { name: "nombre_servicio", alias: "Nombre", required: true, minLength: 3, maxLength: 20 },
  { name: "porcentaje_descuento", alias: "Descuento", required: false, minLength: 1, maxLength: 3 },
];
