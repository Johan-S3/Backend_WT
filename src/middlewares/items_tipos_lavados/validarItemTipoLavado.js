...
/**
 * Middleware de validación para los campos de un registro de la relación entre un item y tipo de lavado.
 * 
 ...
 *
 * @function validarItemTipoLavado
 ...
 */
export function validarItemTipoLavado(req, res, next) {
